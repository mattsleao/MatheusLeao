//CÓDIGO PARA LER UM ARQUIVO TXT EXISTENTE E 
//CRIAR OUTRO ARQUIVO TXT COM O MESMO CONTEÚDO EM MAIÚSCULAS
//O USUÁRIO INFORMARÁ VIA TECLADO O NOME DOS DOIS ARQUIVOS
